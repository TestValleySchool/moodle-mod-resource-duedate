...
/**
 * Strings for component 'resourceduedate', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod_resourceduedate
 * @copyright  1999 onwards Martin Dougiamas  {@link http://moodle.com}, 2015 Test Valley School
...
$string['modulename_help'] = 'Allows teachers to set a Home Learning Task, either with or without an attached file, which will appear properly in the calendar for both pupils and parents, as well as in the course calendar and the list in the main course area.';
